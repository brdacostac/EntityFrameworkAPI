    ...
    public class EntityDbContexte : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                // string path = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "..\\..\\..\\..\\..\\..\\Entity_framework\\Entity_framework.LolDB.db"); // decomenter si vous faite trouner le maui avec le Entity
